...
public class Mapper {
    ...
    static BufferedImage snake2Image;
    ...
    Mapper() throws IOException{
        groundImage = ImageIO.read(new File("res/ground.png"));
        snakeImage = ImageIO.read(new File("res/snake.png"));
        snake2Image = ImageIO.read(new File("res/snake2.png"));
        appleImage = ImageIO.read(new File("res/apple.png"));
    ...
    public void draw(Graphics2D g2){
        ...
        while (currentRow < 8) {
            if (currentCol <= 15) {
                ...
                else if(map[currentRow][currentCol] == 4){
                    g2.drawImage(snake2Image, currentCol*TALE_SIZE, currentRow*TALE_SIZE, TALE_SIZE, TALE_SIZE, null);
                }
                currentCol++;
                if (currentCol ==16) {
                    currentCol = 0;
